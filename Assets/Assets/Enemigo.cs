...
public class Enemigo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (spawner == null)
            spawner = FindObjectOfType<GeneradorEnemigo>();
    }
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        Transform jugador = collision.collider.transform;
        ...
        {
            ScriptPersonaje script = jugador.GetComponent<ScriptPersonaje>();
            if (script != null)
            {
    ...
    IEnumerator SecuenciaMuerte()
    {
        ...
        if (CameraShake.Instance != null)
            CameraShake.Instance.Sacudir(0.1f, 0.2f);
